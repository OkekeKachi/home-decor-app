  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] flex items-center justify-center p-6 relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-96 h-96 bg-[#C9A66B]/10 rounded-full blur-3xl" />
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-[#D4B47A]/10 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-md z-10">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <div className="bg-[#FAF9F6] p-8 text-center border-b border-gray-100">
            ...
            <h1 className="text-3xl font-serif font-bold text-[#1C1C1C] mb-2">
              Create Account
            </h1>

            <p className="text-gray-500">
              Join the Luxe Home community
            </p>
          </div>
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-start space-x-2">
                ...
                >
                  ...
                  <Link
                    href="/terms"
                    className="text-[#B8924A] hover:text-[#A6823C] font-medium hover:underline transition-colors"
                  >
                    Terms of Service
                  </Link>{" "}
                  and{" "}
            ...
            <div className="space-y-3">
              <button
                type="button"
                disabled
                className="w-full flex items-center justify-center space-x-3 border border-gray-200 bg-white py-3 px-6 rounded-xl opacity-60 cursor-not-allowed"
                aria-label="Google registration is currently unavailable"
              >
